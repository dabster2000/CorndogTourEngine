package dk.alumananx.corndogtour.engine.utils;
...
import dk.alumananx.corndogtour.engine.model.Group;
...
public class TextGenerator {
	...
	private List<String> startTexts = new ArrayList<>();
	private List<String> earlyStartTexts = new ArrayList<>();
	private List<String> crashTexts = new ArrayList<>();
	private List<String> groupTexts = new ArrayList<>();
	private List<String> staminaTexts = new ArrayList<>();
	private List<String> commentaryTexts = new ArrayList<>();
	private List<String> attackTexts = new ArrayList<>();
	private List<String> trackChangeTexts = new ArrayList<>();
